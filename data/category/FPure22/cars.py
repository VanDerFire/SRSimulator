...
extcar = car('EXTMotorsport Porsche', porsche, extchassis)

#GoldenFire Racing

gfchassis = chassis("golden Gf1", 27000)

gfcar = car('Pepsi GoldenFire Racing Team', chevy, gfchassis)

#Junín Bull Racing Mercedes

jbmChassis = chassis('Junin Bull JB1', 65000)

jbmCar = car('Junin Bull Racing Mercedes', mercedes, jbmChassis)

#NAOGP Chevy

naochassis = chassis('Nao N22ek', 25000)

naocar = car('Dataperro NAO GP Chevy', chevy, naochassis)

#NOU Mercedes

nouchassis = chassis('Nou papu001', 45000)

noucar = car('Nou Mercedes', mercedes, nouchassis)

#Pilotos Velocistas Ford

pvchassis = chassis('PV22', 20000)

pvcar = car('Pilotos Velocistas Racing Team', ford, pvchassis)

#SUNSET RACING BLUE FORD

sunsetchassis = chassis("Sunset BR22", 70000)

sunsetcar = car('Sunset Racing Blue', ford, sunsetchassis)

#TOTTUS Porsche

tottuschassis = chassis("TOTTUS t1", 30000)

tottuscar = car('Tottus Racing Porsche', porsche, tottuschassis)

#UNOVA SDLG Mercedes

usdlgchassis = chassis('USDLG U-1', 10000)

usdlgcar = car('USDLG Mercedes', mercedes, usdlgchassis)

#Team Yiff

yiffChassis = chassis('Yiff Braixen 1', 25000)

yiffcar = car('E621.NET TEAM YIFF MERCEDES', mercedes, yiffChassis)